...
/*   Updated: 2024/12/19 14:07:43 by cvalim-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static int	parse_arguments(const char *format_string, va_list args);
static int	print_arguments(long n, long base, int uppercase, int is_pointer);
...
static int	parse_arguments(const char *type, va_list args)
{
	int	count;
	int	c;
